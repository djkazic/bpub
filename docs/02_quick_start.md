...
Install dependencies (see `README.md`) or use the Docker image.
...
Then you can create a container and enter it:
```
$ docker run -d --name bpub bpub
$ docker exec -it bpub bash
```
